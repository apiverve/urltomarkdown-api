...
namespace APIVerve.API.URLtoMarkdown
{
    ...
    /// <summary>
    /// Client for the URLtoMarkdown API
    /// </summary>
    public class URLtoMarkdownAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/urltomarkdown";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "includeImages", new ValidationRule { Type = "boolean", Required = false } },
            { "includeLinks", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public URLtoMarkdownAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public URLtoMarkdownAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public URLtoMarkdownAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, URLtoMarkdownQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(URLtoMarkdownQueryOptions options)
        {
        ...
        public ResponseObj Execute(URLtoMarkdownQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(URLtoMarkdownQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(URLtoMarkdownQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(URLtoMarkdownQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(URLtoMarkdownQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(URLtoMarkdownQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(URLtoMarkdownQueryOptions options)
        {
