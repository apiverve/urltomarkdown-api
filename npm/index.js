...
class urltomarkdownWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/urltomarkdown');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/urltomarkdown';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"url":{"type":"string","required":true,"format":"url"},"includeImages":{"type":"boolean","required":false,"default":false},"includeLinks":{"type":"boolean","required":false,"default":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/urltomarkdown`);
        }
    }
...
module.exports = urltomarkdownWrapper;
