import com.apiverve.urltomarkdown.URLtoMarkdownAPIClient;
import com.apiverve.urltomarkdown.APIResponse;
import com.apiverve.urltomarkdown.APIException;
...
public class BasicExample {
    public static void main(String[] args) {
        ...
        URLtoMarkdownAPIClient client = new URLtoMarkdownAPIClient("YOUR_API_KEY_HERE");

        try {
            // Request body
            Map&lt;String, Object&gt; parameters &#x3D; new HashMap&lt;&gt;();
        parameters.put(&quot;url&quot;, &quot;https://example.com/blog/getting-started&quot;);
        parameters.put(&quot;includeImages&quot;, true);
        parameters.put(&quot;includeLinks&quot;, true);
