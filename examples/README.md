# URL to Markdown API - Examples

This folder contains example code for using the URL to Markdown API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/urltomarkdown',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/urltomarkdown](https://docs.apiverve.com/ref/urltomarkdown)
